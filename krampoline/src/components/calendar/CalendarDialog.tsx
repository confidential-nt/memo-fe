            ...
            <DialogContent>
                <DialogContentText>
                    ...
                    <h1 className="w-[30%] h-8 bg-amber-400 border-black border-2 rounded-full flex items-center font-bold justify-center my-1 mr-5 mt-6">DATE</h1>
                        <p className="flex justify-between items-center sm:w-50 md:w-[23rem] lg:w-[23rem] xl:w-[23rem] h-12 border-black border-2 rounded-[15px] shadow-standard bg-white my-4 pl-3 mt-6">
                            {selectedRange?.slots ? (
